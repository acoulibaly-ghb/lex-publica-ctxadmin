      ...
      messages: [
        {
          role: 'model',
          text: isVisitor
            ? `Bonjour ! Je suis **Ada**, l'assistante virtuelle du Professeur **Coulibaly** en **contentieux administratif**. Pour que je puisse suivre votre progression, souhaitez-vous vous identifier ?\n\n[ ] Je veux bien indiquer le prénom ou le pseudo de mon choix\n[ ] Je préfère rester anonyme`
